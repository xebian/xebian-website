...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -avhP --exclude posts --exclude categories --exclude archive.html output/ vanir:/var/www/xebian/",
    ]
}
...
ROBOTS_EXCLUSIONS = ["/archive.html", "/category/*.html", "/debian/*", "/packages/*", "/posts/*"]
